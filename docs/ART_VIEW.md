...
The round display and phone start with seven gradient data traces and no visible labels, numbers, buttons, or guide circles. Swipe left for the existing seven-day detail view, left again for trends, and right to return. Views do not wrap. On desktop, use the Art button or left/right arrow keys.
